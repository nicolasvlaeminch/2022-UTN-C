...
///										PUNTO 1									///
			case 1:
				...
				if(!respuestaMenuUno) {
					...
					case 1:
						costoTotalHospedaje = SumatoriaEntero("\nIngrese el costo del hospedaje en pesos: ", costoTotalHospedaje);
						break;
					case 2:
						costoTotalComida = SumatoriaEntero("\nIngrese el costo de la comida en pesos: ", costoTotalComida);
						break;
					case 3:
						costoTotalTransporte = SumatoriaEntero("\nIngrese el costo del transporte en pesos: ", costoTotalTransporte);
						break;
					}
				}
				break;
...
///										PUNTO 3									///
				if (costoTotalHospedaje != 0 && costoTotalComida != 0 && costoTotalTransporte != 0 && banderaJugadores == 1) {
					...
					costoTotalMantenimiento = costoTotalComida + costoTotalHospedaje + costoTotalMantenimiento;
					banderaResultados = 1;
